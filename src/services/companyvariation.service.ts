...
export class CompanyVariationService {
  ...
  add(variations: Variation) {
    return this.http.post<Variation>(
      `${this.url}/api/variation/add-variation.php`, variations
    );
  }
  update(variations: Variation) {
    return this.http.post<Variation>(
      `${this.url}/api/variation/update-variation.php`, variations
    );
  }
  ...
  deleteVariationOption(VariationOptionId: string) {
    return this.http.get<number>(
      `${this.url}/api/variation-option/delete-variation-option.php?VariationOptionId=${VariationOptionId}`
    );
  }
  deleteVariation(variationId: string) {
    return this.http.get<number>(
      `${this.url}/api/variation/delete-variation.php?VariationId=${variationId}`
    );
  }
