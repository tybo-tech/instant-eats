...
export class ProductVariationService {
  ...
  addSync(ProductVariation: ProductVariation) {
   return this.http.post<ProductVariation>(`${this.url}/api/product-variation/add-product-variation.php`, ProductVariation);
  }
  updateSync(ProductVariation: ProductVariation) {
   return this.http.post<ProductVariation>(`${this.url}/api/product-variation/update-product-variation.php`, ProductVariation);
  }
  ...
  deleteProductOption(id: string) {
    return this.http.get<number>(`${this.url}/api/product-variation-option/delete-product-variation-option-id.php?Id=${id}`);
  }
  ...
  addProductVariationOption(productVariation: ProductVariationOption): Observable<ProductVariationOption> {
    return this.http.post<ProductVariationOption>(`${this.url}/api/product-variation-option/add-product-variation-option.php`,
      productVariation);
  }
  addProductVariationOptionRange(productVariation: ProductVariationOption[]): Observable<ProductVariationOption[]> {
    return this.http.post<ProductVariationOption[]>(`${this.url}/api/product-variation-option/add-product-variation-option.php`,
      productVariation);
  }
