...
export class RequestComponent implements OnInit {
  ...
  constructor(private orderService: OrderService, private userService: UserService, private accountService: AccountService) { }
  ...
  accept() {
    ...
    if (this.user) {
      this.user.DriverStatus = this.order.DriverStatus;
